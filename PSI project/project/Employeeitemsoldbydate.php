...
<p >Total Sales of <strong><?php echo "<p> $date </p> ";?></strong> Rupees<p>
	    <b> <?php
...
$result1 = mysqli_query($db,"select sum(sales) FROM sales where date='$date'");
